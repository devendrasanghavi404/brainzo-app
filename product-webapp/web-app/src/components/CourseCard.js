    ...
    if (course < 0) {
      fetchCourseById(courseId).then((resp) => {
        ...
        if(localStorage.getItem("role") == "MENTOR"){
          ...
          resp.data.learner.forEach(({learnerEmailId }) => {
            if(learnerEmailId === localStorage.getItem('user')){
              // set enroll or Start Learning
              if(resp.data.courseType === "recorded") {
...
const onSubmit=(data)=>{
  ...
  axios.post('https://brainzo.stackroute.io/email-service/sendMail', {
      ...
      "messageBody": "Hi, \nHope you are having a good day. Your friend just recommeded a course for enhancing your skills. Checkout this course at http://localhost:3000/courses/"+courseId+"\n Team Brainzo",
          ...
          <Box sx={{ flexGrow: 1 }}>
                ...
                <Item>
                  <Box sx={{ width: "100%" }}>
                      ...
                      <CardMedia
                        ...
                        height="auto"
                        aspect-ratio= {16/7}
                        src={`data:image/png;base64,${course.courseImage.data}`}
                        alt="react"
                      />
            ...
            <div className="email" >
                  ...
                  <div className="created">
                   ...
                   { (localStorage.getItem("role") == "LEARNER" || localStorage.getItem("role") == "MENTOR" ) && <button  className="Btn-Login text-light course-button" type="submit" style={{paddingLeft:30  , paddingRight:30,
